...
class CelebritiesTrendingAdapter(
    val list: List<CelebritiesResult>,
    val onItemClickListener: ItemClickInterface
) : RecyclerView.Adapter<CelebritiesTrendingAdapter.CelebritiesTrendingViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): CelebritiesTrendingViewHolder = CelebritiesTrendingViewHolder(
    ...
    inner class CelebritiesTrendingViewHolder(private val binding: ItemCelebritiesTrendingBinding) :
