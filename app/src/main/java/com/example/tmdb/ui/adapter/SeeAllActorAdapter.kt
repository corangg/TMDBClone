...
class SeeAllActorAdapter(
    val list: MutableList<CelebritiesResult>,
    val onItemClickListener: ItemClickInterface
) : RecyclerView.Adapter<SeeAllActorAdapter.SeeAllActorViewHolder>() {
    ...
    inner class SeeAllActorViewHolder(private val binding: ItemActorSeeAllBinding) :
