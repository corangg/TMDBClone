...
class SeeAllMovieActorAdapter(
    val list: MutableList<Cast>,
    val onItemClickListener: ItemClickInterface
) : RecyclerView.Adapter<SeeAllMovieActorAdapter.SeeAllMovieActorViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SeeAllMovieActorViewHolder =
        SeeAllMovieActorViewHolder(
            ItemActorSeeAllBinding.inflate(
    ...
    inner class SeeAllMovieActorViewHolder(private val binding: ItemActorSeeAllBinding) :
