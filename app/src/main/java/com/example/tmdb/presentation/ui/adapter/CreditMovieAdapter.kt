...
class CreditMovieAdapter(val list: List<ActorCast>, val onItemClickListener: ItemClickInterface) :
    RecyclerView.Adapter<CreditMovieAdapter.CreditMovieViewHolder>() {
    override fun getItemCount(): Int {
        return list.size
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CreditMovieViewHolder =
        CreditMovieViewHolder(
    ...
    inner class CreditMovieViewHolder(private val binding: ItemNowPlayingBinding) :
